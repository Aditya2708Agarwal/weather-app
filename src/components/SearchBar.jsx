    ...
    return (
        <div className="relative w-full max-w-2xl " ref={searchRef}>
            ...
            </form>
            {
                ...
                <button className='w-full px-6 py-3 text-left hover:bg-white/10 transition-all duration-200 flex items-center justify-between group-border-b border-white/10 last:border-b-0'><div className='font-medium text-white group-hover:text-white'>New York, USA
                    <span>View All</span>
                </div>
                <div className='text-md text-white/50'>Population: 8,336,817</div>
